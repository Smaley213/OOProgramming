...
public class Client {
    ...
    public void run() {
        System.out.println("Hello =) I call you?");
        customer.setName(checkInputName());

        Director presentDirector = new Director();
        presentDirector.setBuilder(new CandyBuilder());
    ...
    private static List<Product> readCandyFile() {
        ...
        String filePath = "src/by/htp/Text/Candy.txt";
        try {
